...
<section class="content animated fadeInRight">
    ...
    <form role="form">
						...
						<?php if ( isset( $product )) { ?>
							...
							<?php if ( !empty( $colors )){ ?>
								...
								<?php 
									...
									$i++;
								?>
								<div id="<?php echo 'colorvalue' . $i ?>" class="input-group ">
									<?php echo form_input(array(
										'name' => 'colorvalue' . $i,
							...
							<?php }else{ ?>
								<div id="colorvalue1" class="input-group ">
									<?php echo form_input(array(
										'name' => 'colorvalue1',
										'value' => '',
										'class' => 'form-control form-control-sm mt-1',
		...
		?>
		<input type="hidden" id="color_total" name="color_total" value="<?php echo $color_count; ?>">
